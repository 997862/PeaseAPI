...
$router->get('/api/login-logs/self', withAuth(fn($req) => $loginLogController->listSelf($req)));
...
$router->get('/api/options/{key}', withAdminAuth(fn($req) => $optionController->get($req)));
